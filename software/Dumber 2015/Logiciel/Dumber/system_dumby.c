...
void SysTick_Handler(void)
{
	...
	if((Dumber.WatchDogStartEnable == TRUE) && (Dumber.StateSystem != IDLE)) Dumber.cpt_watchdog+=50;
	...
	if(Dumber.cpt_systick>=950 && Dumber.cpt_systick<=50)	watchDogState=TRUE;
	...
	//if(Dumber.cpt_inactivity>=120000)	shutDown();
